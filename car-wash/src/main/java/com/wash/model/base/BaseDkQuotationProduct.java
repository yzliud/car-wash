...
public abstract class BaseDkQuotationProduct<M extends BaseDkQuotationProduct<M>> extends Model<M> implements IBean {
	...
	public M setDemandArea(java.lang.Float demandArea) {
		set("demand_area", demandArea);
		return (M)this;
	}

	public java.lang.Float getDemandArea() {
		return get("demand_area");
	}
