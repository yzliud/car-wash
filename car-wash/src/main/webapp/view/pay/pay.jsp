...
String controllerKey = (String)request.getAttribute("controllerKey");
...
<html>
  ...
  <body>
  	<div id="controllerKey" style="display: none;"><%=controllerKey%></div>
  	<div id="methodName" style="display: none;"><%=methodName%></div>
  	<div id="domainName" style="display: none;"><%=domainName%></div>
  </body>
		  ...
		  WeixinJSBridge.invoke('getBrandWCPayRequest',{
		  		 "appId" : "<%=appId%>","timeStamp" : "<%=timeStamp%>", "nonceStr" : "<%=nonceStr%>", "package" : "<%=packageValue%>","signType" : "MD5", "paySign" : "<%=paySign%>" 
			            ...
			            if(res.err_msg == "get_brand_wcpay_request:ok"){  
			            	alert("微信支付成功!"); 
			            	window.location.href = $("#domainName").html()+$("#controllerKey").html()+"/"+$("#methodName").html();
